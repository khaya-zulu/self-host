...
type Enum_public_transaction_type = 'DEPOSIT' | 'WITHDRAWAL';
interface Table_public_transaction {
  id: string;
  type: Enum_public_transaction_type;
  reference: string;
...
interface Tables_relationships {
  "public.Transaction": {
    parent: {
       Transaction_createdByUsername_fkey: "public.User";
    };
    children: {

    };
    parentDestinationsTables: "public.User" | {};
  ...
  "public.User": {
    ...
    children: {
       Transaction_createdByUsername_fkey: "public.Transaction";
    };
    parentDestinationsTables:  | {};
    childDestinationsTables: "public.Transaction" | {};
